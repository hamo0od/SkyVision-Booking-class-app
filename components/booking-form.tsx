        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-green-900">Booking Submitted Successfully!</h3>
              <p className="text-green-800 mt-1">{successMessage}</p>
              <p className="text-green-700 text-sm mt-2">
                Your booking request has been sent to the admin for approval. You will receive a notification once it's
                reviewed.
              </p>
            </div>
            <button
