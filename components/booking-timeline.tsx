        ...
        <div className="overflow-x-auto">
          <div className="min-w-[800px]">
            ...
            <div className="grid grid-cols-[100px_1fr] gap-2 mb-4">
              ...
              <div className={`grid grid-cols-${timelineData.classrooms.length} gap-2`}>
                {timelineData.classrooms.map((classroom) => (
                  <div key={classroom.id} className="text-center p-2 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="font-medium text-sm text-blue-800 flex items-center justify-center gap-1">
            ...
            <div className="space-y-1">
              {timeSlots.map((timeSlot) => (
                <div key={timeSlot} className="grid grid-cols-[100px_1fr] gap-2">
                  <div className="text-sm font-mono text-gray-600 py-2 px-2 bg-gray-50 rounded border">{timeSlot}</div>
                  <div className={`grid grid-cols-${timelineData.classrooms.length} gap-2`}>
                    {timelineData.classrooms.map((classroom) => {
                      ...
                      if (booking) {
                        ...
                        return (
                          <div
                            ...
                            className={`p-2 rounded border-2 ${getStatusColor(booking.status)} ${
                          ...
                          >
                            {isStartSlot && (
                              <>
                                ...
                                <div className="text-xs truncate mt-1">{booking.purpose}</div>
                      ...
                      return (
                        <div
                          key={`${classroom.id}-${timeSlot}`}
                          className="p-2 rounded border border-gray-200 bg-white hover:bg-green-50 transition-colors"
                        >
